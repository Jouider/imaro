...
const MOCK_DEPENSES: DepenseFinance[] = [
  ...
  },
  {
    ...
    residence_id: 1,
    residence_nom: 'Atlas Casablanca',
    titre: 'Maintenance ascenseur Février 2026',
    montant: 2800,
    date: '2026-02-03',
    prestataire_id: 3,
  ...
  },
  {
    ...
    residence_id: 1,
    residence_nom: 'Atlas Casablanca',
    titre: 'Réparation porte palière Mars 2026',
    montant: 650,
    date: '2026-03-15',
    prestataire_id: 4,
    prestataire_nom: 'Atlas Serrurerie',
    compte_charge: '6138',
    libelle_compte: 'Entretien divers',
  ...
  },
  {
    ...
    residence_id: 1,
    residence_nom: 'Atlas Casablanca',
    titre: 'Assurance multirisque 2026',
    montant: 2400,
    date: '2026-04-05',
    prestataire_id: null,
...
const MOCK_STATS: DepensesStats = {
  ...
  top_comptes: [
    { compte: '6111', libelle: 'Gardiennage', montant: 3500, pct: 29 },
    { compte: '6131', libelle: 'Maintenance', montant: 2800, pct: 23 },
    { compte: '6161', libelle: 'Assurances', montant: 2400, pct: 20 },
    { compte: '6171', libelle: 'Nettoyage', montant: 1500, pct: 12 },
  ],
  top_prestataires: [
