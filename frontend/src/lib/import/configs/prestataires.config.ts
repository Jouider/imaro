...
export const prestatairesConfig: ImportConfig<PrestataireImportPayload> = {
  ...
  columns: [
    {
      ...
      aliases: ['nom', 'raison sociale', 'entreprise', 'name', 'societe', 'société', 'fournisseur'],
      type: 'string',
      required: true,
    },
    {
      key: 'specialite',
      label: 'Spécialité',
      aliases: ['specialite', 'spécialité', 'metier', 'métier', 'service', 'activite', 'activité'],
      type: 'string',
      required: false,
    },
    {
  ...
  templateExampleRows: [
    { nom: 'OTIS Maroc', specialite: 'Ascenseurs', telephone: '0522123456', email: 'contact@otis.ma', adresse: 'Casablanca' },
    { nom: 'ProNet Services', specialite: 'Nettoyage', telephone: '0661234567', email: '', adresse: 'Rabat' },
  ],
}
