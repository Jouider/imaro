...
import {
  getTravauxExceptionnels,
  createTravaux,
  updateTravaux,
  deleteTravaux,
  type TravauxExceptionnel,
  type TravauxStatus,
  type CreateTravauxInput,
...
export function TravauxExceptionnelsPage() {
  ...
  const openEdit = (tr: TravauxExceptionnel) => {
    setEditing(tr)
    setDraft({
      residence_id: tr.residence_id,
      libelle: tr.libelle,
      description: tr.description,
      date_vote_ag: tr.date_vote_ag,
      ag_id: tr.ag_id,
      prestataire: tr.prestataire,
      montant_vote: tr.montant_vote,
      montant_engage: tr.montant_engage,
      montant_regle: tr.montant_regle,
      date_debut: tr.date_debut,
      date_fin_prevue: tr.date_fin_prevue,
      date_fin_reelle: tr.date_fin_reelle,
      statut: tr.statut,
    })
    setModalOpen(true)
  }
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setDraft({ ...draft, date_vote_ag: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setDraft({ ...draft, prestataire: e.target.value })
                  }
                />
              </div>
            </div>
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <Input
                  ...
                  min="0"
                  step="0.01"
                  value={draft.montant_vote || ''}
                  onChange={(e) =>
                    setDraft({ ...draft, montant_vote: Number(e.target.value) })
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  min="0"
                  step="0.01"
                  value={draft.montant_engage || ''}
                  onChange={(e) =>
                    setDraft({
                      ...draft,
                      montant_engage: Number(e.target.value),
                    })
                  }
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  min="0"
                  step="0.01"
                  value={draft.montant_regle || ''}
                  onChange={(e) =>
                    setDraft({
                      ...draft,
                      montant_regle: Number(e.target.value),
                    })
                  }
                />
              </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setDraft({ ...draft, date_fin_prevue: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <Select
                  value={draft.statut}
                  onValueChange={(v) =>
                    setDraft({ ...draft, statut: v as TravauxStatus })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
