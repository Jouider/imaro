...
save(
  makeWorkbook('Copropriétaires', [
    ...
    { nom: 'Hassan Oufkir', telephone: '0663456789', email: '', lot: 'A-03' },
    {
      ...
      email: 'a.moussaoui@outlook.com',
      lot: 'B-01',
    },
    {
      nom: 'Mohamed Tazi',
      telephone: '0665678901',
      email: 'm.tazi@yahoo.fr',
      lot: 'B-02',
    },
    {
      nom: 'Rachida El Fassi',
      telephone: '0666789012',
      email: '',
      lot: 'P-01',
    },
    {
      nom: 'Youssef Benkirane',
      telephone: '0667890123',
      email: 'y.benkirane@gmail.com',
      lot: 'P-02',
    },
    {
      nom: 'Leila Cherkaoui',
      telephone: '0668901234',
      email: 'l.cherkaoui@gmail.com',
      lot: 'C-01',
    },
  ]),
...
save(
  makeWorkbook('Soldes initiaux', [
    { lot: 'A-01', solde: 1500.0, date: '2026-01-01' },
    { lot: 'A-02', solde: 0.0, date: '2026-01-01' },
    { lot: 'A-03', solde: -850.0, date: '2026-01-01' },
    { lot: 'B-01', solde: 2200.5, date: '2026-01-01' },
    { lot: 'B-02', solde: 0.0, date: '2026-01-01' },
    { lot: 'P-01', solde: 300.0, date: '2026-01-01' },
    { lot: 'P-02', solde: 0.0, date: '2026-01-01' },
    { lot: 'C-01', solde: -400.0, date: '2026-01-01' },
  ]),
  'test-soldes.xlsx',
)
...
save(
  makeWorkbook('Prestataires', [
    ...
    {
      nom: 'Gardiennage Atlas',
      metier: 'Sécurité',
      telephone: '0522556677',
      email: 'atlas.guard@outlook.com',
      ville: 'Casablanca',
    },
    {
      nom: 'ElectroFix Rabat',
      metier: 'Électricité',
      telephone: '0537667788',
      email: 'electrofix@gmail.com',
      ville: 'Rabat',
    },
    {
